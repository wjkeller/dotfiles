...
alias asucd-cm='ssh web@169.237.101.248'
alias asucd-dev='ssh web@asucd-dev.ucdavis.edu'
alias asucd-elections='ssh appark@elections.ucdavis.edu'
...
alias asucd-stormtrooper='ssh appark@stormtrooper.ucdavis.edu'
